...
- (instancetype)init
{
    ...
    if (self) {
        ...
        if (kWidth == 320 ) {
            ...
            self.headerReferenceSize = CGSizeMake(375.0f, 65.0f);//头部视图的框架大小
            
            self.itemSize = CGSizeMake(375/7, 80.0f);//每个cell的大小
            
        }
        else if (kWidth == 414){
            self.headerReferenceSize = CGSizeMake(414.0f, 65.0f);//头部视图的框架大小
            
            self.itemSize = CGSizeMake(414/7, 90.0f);//每个cell的大小
        }
