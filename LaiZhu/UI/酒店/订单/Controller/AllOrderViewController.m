...
static NSString  *const allOrderCellId = @"AllOrderCell";
...
{
    AllOrderCell *cell = [tableView dequeueReusableCellWithIdentifier:allOrderCellId];
    if (!cell) {
        cell = [[AllOrderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:allOrderCellId];
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    [button setTitle:@"Payment" forState:UIControlStateNormal];
...
//    tableView.separatorStyle = UITableViewCellSelectionStyleNone;
    ...
    [tableView registerNib:[UINib nibWithNibName:allOrderCellId bundle:nil] forCellReuseIdentifier:allOrderCellId];
