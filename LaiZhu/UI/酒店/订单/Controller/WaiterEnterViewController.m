...
#import "WaiterEnterViewController.h"
#import "AllOrderCell.h"

static NSString  *const waiterEnterCellId = @"AllOrderCell";

@interface WaiterEnterViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WaiterEnterViewController
...
{
    AllOrderCell *cell = [tableView dequeueReusableCellWithIdentifier:waiterEnterCellId];
    if (!cell) {
        cell = [[AllOrderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:waiterEnterCellId];
    }
...
- (void)setupContent
{
    ...
    [tableView registerNib:[UINib nibWithNibName:waiterEnterCellId bundle:nil] forCellReuseIdentifier:waiterEnterCellId];
