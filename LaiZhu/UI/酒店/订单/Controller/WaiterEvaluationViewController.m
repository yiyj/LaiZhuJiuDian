//
//  WaiterEvaluationViewController.m
//  LaiZhu
//
...
#import "WaiterEvaluationViewController.h"
#import "AllOrderCell.h"

static NSString  *const evaluationCellId = @"AllOrderCell";

@interface WaiterEvaluationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WaiterEvaluationViewController
...
{
    AllOrderCell *cell = [tableView dequeueReusableCellWithIdentifier:evaluationCellId];
    if (!cell) {
        cell = [[AllOrderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:evaluationCellId];
    }
